...
I'm a Computer Science student (graduating 2027) and Front-End Developer who builds **real, deployed products** — not just UI mockups. My focus is React.js and Next.js applications that are clean under the hood and polished on the surface. I'm currently expanding into back-end development with **C# and .NET**, working toward being a well-rounded full-stack engineer.
...
- **Backend-curious** — learning C#, ASP.NET, and SQL to build complete, end-to-end apps
